...
## Alignment filtering
Prior to substitution model training, all datasets should be realigned using Muscle5. Filtering was then performed using a variety tools as described in the paper methods
