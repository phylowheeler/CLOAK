...
QC.arch, QC.bac, and QC.pfam were not used to generate figures in this paper, but are available for general use. Along with QC.mammal, they are also available on IQTree.
